        ...
        (function (acak) {
            ...
            `;
                ...
                reset() {
                    ...
                    console.log('acak reset');
                    console.log(this._catList);
                }
                updateCatLabel() {
                    if (this._catList.length > 0) {
                        this.spanEl.innerText = this._catList[this._catNo].cat.label + ' (' + this._catList[this.catNo].jml + ' soal)';
                    }
                }
                update() {
